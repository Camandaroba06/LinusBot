...
class Cronus(tk.Frame):
    ...
    def voltas(self):
        ...
        if self.conta_voltas == 1:
            self.tempo_volta1.config(

                text=minutes_string + ":" + seconds_string + ":" + millis_string)
        if self.conta_voltas == 2:
            self.tempo_volta2.config(
                text=minutes_string + ":" + seconds_string + ":" + millis_string)
        if self.conta_voltas == 3:
            self.tempo_volta3.config(
                text=minutes_string + ":" + seconds_string + ":" + millis_string)
        if self.conta_voltas == 4:
            self.tempo_volta4.config(
                text=minutes_string + ":" + seconds_string + ":" + millis_string)
            self.conta_voltas = 0
